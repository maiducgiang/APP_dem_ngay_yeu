...
import 'package:mubaha/ui/screen/sign_up%20copy/firebase/firebase_manager.dart';
...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  static final _gsheets = GSheets({
    ...
    "private_key_id": "80b8ba98556cbadec559d8e318a1446b4c0c14df",
    "private_key":
  ...
  Future initGoogleSheet() async {
    try {
      final spreadsheet = await _gsheets.spreadsheet("1FrHvwFD42E7cFRhWEhNXWeHYf3Xz-xJAunVjN6VHjeQ");
...
class SheetsColumn {
  ...
  static const confirmAge = "confirm_age";

  static List<String> getColumns() => [
    shopName, username, nickname, password, phone, receiveMessage, confirmAge];
}
