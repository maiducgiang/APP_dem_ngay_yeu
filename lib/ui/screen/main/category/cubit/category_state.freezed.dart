...
mixin _$CategoryState {
  ...
  List<Category> get listCategory => throw _privateConstructorUsedError;
...
class _$_CategoryState implements _CategoryState {
  ...
  @override
  String toString() {
    return 'CategoryState(isLoading: $isLoading, listCategory: $listCategory, message: $message, error: $error)';
  }
